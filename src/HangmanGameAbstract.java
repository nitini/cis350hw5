...
public abstract class HangmanGameAbstract {
	...
	public HangmanGameAbstract(String secretWord, int numGuesses, String letterHistory) {
		this.secretWord = secretWord;
		this.guessesRemaining = numGuesses;
		this.letterHistory = letterHistory;
	}
	
	public HangmanGameAbstract(int stringLength, int numGuesses) {
